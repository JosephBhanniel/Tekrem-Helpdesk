...
$sql = "INSERT INTO technician (ID, Firstname, Lastname, Job_title, email, Dept, Username, password, reset_token) VALUES (?,?, ?, ?, ?, ?, ?, ?, ?)";
...
<div class="card-body">
    ...
    <p class="card-text text-center">
    Go back to<a class="btn btn-dark" href="dashboard.php?id=g">Dashboard</a>.
    </p>
</div>
</div>
</div>
...
<!-- REGISTRATION FORM -->
  ...
  <table>
    ...
    <div class="form-group">
      ...
      <td><input type="text" name="ID" class="form-control col-md-3" rows="1" placeholder="e.g 100214"  value="<?php echo isset($_POST['ID']) ? $_POST['ID'] : ''; ?>" required></td>
    ...
    <div class="form-group">
      ...
      <td><input type="text" name="first_name"  class="form-control col-md-3" rows="1" placeholder="e.g James" value="<?php echo isset($_POST['first_name']) ? $_POST['first_name'] : ''; ?>" required></td>
    ...
    <div class="form-group">
      ...
      <td><input type="text" name="last_name" class="form-control col-md-3" rows="1"  placeholder="e.g Muyelu" value="<?php echo isset($_POST['last_name']) ? $_POST['last_name'] : ''; ?>" required></td>
    ...
    <div class="form-group">
      ...
      <td><input type="text" name="job_title" class="form-control col-md-3" rows="1" placeholder="e.g Supervisor"  value="<?php echo isset($_POST['job_title']) ? $_POST['job_title'] : ''; ?>" required></td>
    ...
    <div class="form-group">
      ...
      <td><input type="email" name="email" class="form-control col-md-3" rows="1" placeholder="e.g james@tekrem.com"  value="<?php echo isset($_POST['email']) ? $_POST['email'] : ''; ?>" required></td>
    ...
    <div class="form-group">
      ...
      <td><input type="text" name="username" class="form-control col-md-3" rows="1" placeholder="e.g Jmuyelu"  value="<?php echo isset($_POST['username']) ? $_POST['username'] : ''; ?>" required></td>
    ...
    <div class="form-group">
      ...
      <td><input type="password" name="password" class="form-control col-md-3" rows="1"  required></td>
    ...
    <div class="form-group">
      ...
      <td><input type="password" class="form-control col-md-3" rows="1" name="confirm_password" required></td>
    ...
    <div  class="form-group text-center">
      ...
      <p class="mt-2">
      Go back to <a class="m-2" href="dashboard.php?id=g">Admin Dashboard</a>
      </p>
      </div>
   </div>
</body>
